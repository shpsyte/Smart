class RevenueJS {
    InitAdd() {
        ...
        botao.addEventListener('click', () => {
            ...
            var parametros = { TotalSeq: $("#RevenueTotalSeq").val(), Value: $("#Total").val(), DataInicial: $("#DueDate").val() };
    ...
    InitList() {
        ...
        $(document).on("click", ".pay", function () {
            $(".modal-body #RevenueId").val($(this).data('id'));
