...
namespace Smart.Helpers
{
    public static class StringExtensions
    {
        ...
        public static string Truncate(this string s, int length, bool addetc)
        {
            if (s.Length > length)
                return string.Concat(s.Substring(0, length), (addetc ? "..." : ""));
            return s;
        }

        public static string TruncateDisplayFor(this IHtmlContent s, int length, bool addetc)
        {
